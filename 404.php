		...
		<section class="error-404 not-found">
			...
			<div class="page-content">
				...
				<?php
					...
					$wordpress_template_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'wordpress_template' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$wordpress_template_archive_content" );
